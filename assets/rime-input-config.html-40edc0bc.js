import{_ as p,W as c,X as o,Z as n,$ as s,Y as e,a0 as t,C as l}from"./framework-d1b6b6e6.js";const i={},u=t(`<h1 id="rime-中州韵输入法配置" tabindex="-1"><a class="header-anchor" href="#rime-中州韵输入法配置" aria-hidden="true">#</a> RIME 中州韵输入法配置</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> <span class="token parameter variable">--cask</span> squirrel
