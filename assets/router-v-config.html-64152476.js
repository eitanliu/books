...
http://cp.cloudflare.com/generate_204
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="nginx-1" tabindex="-1"><a class="header-anchor" href="#nginx-1" aria-hidden="true">#</a> Nginx</h4><p><code>vim /etc/nginx/sites-enabled/default.conf</code> <sup class="footnote-ref"><a href="#footnote1">[1:1]</a><a class="footnote-anchor" id="footnote-ref1:1"></a></sup></p><div class="language-ini line-numbers-mode" data-ext="ini"><pre class="language-ini"><code>server {
    listen       443 http2;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="meek" tabindex="-1"><a class="header-anchor" href="#meek" aria-hidden="true">#</a> Meek</h3><h4 id="service-1" tabindex="-1"><a class="header-anchor" href="#service-1" aria-hidden="true">#</a> Service</h4><p>config file <code>/usr/local/etc/v2ray/config.json</code> <sup class="footnote-ref"><a href="#footnote2">[2]</a><a class="footnote-anchor" id="footnote-ref2"></a></sup> <sup class="footnote-ref"><a href="#footnote3">[3]</a><a class="footnote-anchor" id="footnote-ref3"></a></sup> <sup class="footnote-ref"><a href="#footnote4">[4]</a><a class="footnote-anchor" id="footnote-ref4"></a></sup></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  <span class="token property">&quot;log&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
systemctl start v2ray
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr class="footnotes-sep">`,21),S={class:"footnotes"},z={class:"footnotes-list"},E={id:"footnote1",class:"footnote-item"},N={href:"https://pylab.me/blog/post/929d18d8-1b90-47cf-82ce-1a4e75e05417",target:"_blank",rel:"noopener noreferrer"},V=n("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1),R=n("a",{href:"#footnote-ref1:1",class:"footnote-backref"},"↩︎",-1),$={id:"footnote2",class:"footnote-item"},P={href:"https://cscot.pages.dev/2023/05/31/v2ray-meek/",target:"_blank",rel:"noopener noreferrer"},A=n("a",{href:"#footnote-ref2",class:"footnote-backref"},"↩︎",-1),I={id:"footnote3",class:"footnote-item"},X={href:"https://github.com/v2fly/v2ray-core/discussions/2549",target:"_blank",rel:"noopener noreferrer"},B=n("a",{href:"#footnote-ref3",class:"footnote-backref"},"↩︎",-1),L={id:"footnote4",class:"footnote-item"},F={href:"https://gist.github.com/xiaokangwang/b8f3a77780cae99eba68e7b127522883",target:"_blank",rel:"noopener noreferrer"},M=n("a",{href:"#footnote-ref4",class:"footnote-backref"},"↩︎",-1);function T(H,O){const a=l("ExternalLinkIcon");return p(),i("div",null,[c,n("p",null,[n("a",u,[s("配置文档 V5"),e(a)]),s("、 "),n("a",d,[s("配置文档 V4"),e(a)])]),v,k,n("p",null,[n("a",m,[s("nginx反向代理location与proxy_pass配置规则总结"),e(a)])]),n("p",null,[n("a",b,[s("Nginx - 反向代理location与proxy_pass配置规则总结（附样例）"),e(a)])]),n("p",null,[n("a",q,[s("nginx反向代理正则匹配示例及nginx内置变量详解"),e(a)])]),h,n("p",null,[n("a",g,[s("使用openssl创建https证书-腾讯云开发者社区"),e(a)])]),f,n("p",null,[n("a",_,[s("Openssl 生成ECC证书及密钥"),e(a)]),y,n("a",x,[s("openssl 生成多级X.509 v3 ECC公钥证书链完整示例原创"),e(a)]),w,n("a",C,[s("Cloudflare自签名SSL证书"),e(a)])]),j,n("section",S,[n("ol",z,[n("li",E,[n("p",null,[n("a",N,[s("如何在V2Ray中，配置gRPC作为传输方式 - Pylab.ME"),e(a)]),s(),V,s(),R])]),n("li",$,[n("p",null,[n("a",P,[s("Example of V2Ray with meek"),e(a)]),s(),A])]),n("li",I,[n("p",null,[n("a",X,[s("v5.7.0 User Preview"),e(a)]),s(),B])]),n("li",L,[n("p",null,[n("a",F,[s("client.jsonv5.json"),e(a)]),s(),M])])])])])}const W=o(r,[["render",T],["__file","router-v-config.html.vue"]]);export{W as default};
