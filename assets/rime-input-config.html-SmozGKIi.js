import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as c,o,c as l,b as n,d as s,a as e,e as t}from"./app-q2oGakC7.js";const i={},u=t(`<h1 id="rime-中州韵输入法配置" tabindex="-1"><a class="header-anchor" href="#rime-中州韵输入法配置" aria-hidden="true">#</a> RIME 中州韵输入法配置</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> <span class="token parameter variable">--cask</span> squirrel
